                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <img src="{{ asset('assets/img/logo/logo.png') }}" alt="WorkSpace"
                                    style="height: 25px;">
                                <span class="app-brand-text demo text-heading fw-bold">WorkSpace</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 text-center">Welcome to WorkSpace! 👋</h4>
